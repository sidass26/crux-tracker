...
const ChartTooltipContent = ({
  ...
  return (
    <div
      ref={ref}
      className={twMerge(
        "grid min-w-[12rem] items-start gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-2 text-gray-900 text-xs shadow-xl",
        className,
      )}
    >
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  >
                    ...
                    {item.value && (
                      <span className="font-medium font-mono text-gray-900 tabular-nums">
